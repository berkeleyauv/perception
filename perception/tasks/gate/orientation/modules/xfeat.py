...
from perception.tasks.gate.orientation.modules.interpolator import InterpolateSparse2d
...
class XFeat(nn.Module):
	...
	def match_lighterglue(self, d0, d1, min_conf = 0.1):
		...
		if not self.kornia_available:
			...
			from perception.tasks.gate.orientation.modules.lighterglue import LighterGlue
