...
GateSequenceTracker
--------------------
Wraps urb_slalom.detector.SlalomDetector to add the pieces the RoboSub
...
Drop this file next to detector.py in src/urb_slalom/ and import
SlalomDetector + PassSide + SlalomEstimate as shown below.
"""
...
from perception.tasks.StatefulTaskTracker import StatefulTaskTracker
from perception.tasks.slalom.classical.slalom_detector import PassSide, SlalomEstimate
...
class SlalomSequenceTracker(StatefulTaskTracker):
    """
...
GateSequenceTracker = SlalomSequenceTracker
